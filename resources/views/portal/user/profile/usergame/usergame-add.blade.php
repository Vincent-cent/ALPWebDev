...
@section('title', 'Tambah Game ID - TOSHOP')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h2 class="text-white fw-bold mb-0">TAMBAH GAME ID</h2>
                        <p class="text-white-50 mb-0">Tambahkan ID game untuk memudahkan transaksi</p>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-lg" style="background: rgba(52, 73, 94, 0.9); border-radius: 20px;">
                    <div class="card-body p-4">
                        <form action="{{ route('usergame.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="d-flex gap-3">
                                <button type="submit" class="btn rounded-pill px-4 py-2 flex-fill fw-semibold" 
                                    ...
                                    <i class="fas fa-save me-2"></i>Simpan Game ID
                                </button>
