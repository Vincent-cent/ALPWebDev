...
@section('title', 'Edit Promo Notification')
...
@section('content')
    ...
    <main class="admin-main-content">
        <div class="container-fluid py-4">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.promo-notifikasi.update', $notification) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="5" required>{{ old('description', $notification->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('promo_code_id') is-invalid @enderror" 
                                ...
                                @foreach($promoCodes as $promo)
                                    <option value="{{ $promo->id }}" {{ old('promo_code_id', $notification->promo_code_id) == $promo->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-3">
                                ...
                                <img src="{{ asset('storage/' . $notification->image) }}" alt="Current" 
